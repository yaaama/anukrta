...
#define SQLITE_TRACE_CLOSE 0x08
  ...
  */
  SQLITE_API int sqlite3_set_errmsg(sqlite3 *db,
                                    int errcode,
                                    const char *zErrMsg);
  ...
  */
  struct sqlite3_module {
    ...
    ** Those below are for version 4 and greater. */
    int (*xIntegrity)(sqlite3_vtab *pVTab,
                      const char *zSchema,
                      const char *zTabName,
                      int mFlags,
                      char **pzErr);
...
#define SQLITE_STATUS_MALLOC_COUNT 9
  ...
  */
  SQLITE_API int sqlite3_db_status(sqlite3 *,
                                   ...
                                   int *pHiwtr,
                                   int resetFlg);
  SQLITE_API int sqlite3_db_status64(sqlite3 *,
                                     int,
                                     sqlite3_int64 *,
                                     sqlite3_int64 *,
                                     int);
...
*/
  ...
  */
  SQLITE_API int sqlite3_snapshot_get(sqlite3 *db,
                                      const char *zSchema,
  ...
  ** [SQLITE_ENABLE_SNAPSHOT] compile-time option is used.
  */
  SQLITE_API int sqlite3_snapshot_open(sqlite3 *db,
                                       const char *zSchema,
  ...
  */
  SQLITE_API int sqlite3_snapshot_cmp(sqlite3_snapshot *p1,
                                      sqlite3_snapshot *p2);
...
#  define SQLITE_SESSION_CONFIG_STRMSIZE 1
  ...
  */
  SQLITE_API int sqlite3changegroup_config(sqlite3_changegroup *,
                                           int,
                                           void *pArg);
...
#  define SQLITE_CHANGEGROUP_CONFIG_PATCHSET 1
  ...
  */
  SQLITE_API int sqlite3changegroup_change_int64(sqlite3_changegroup *,
                                                 int bNew,
                                                 int iCol,
                                                 sqlite3_int64 iVal);
  ...
  */
  SQLITE_API int sqlite3changegroup_change_null(sqlite3_changegroup *,
                                                int,
                                                int);
  ...
  ** instead of a 64-bit integer.
  */
  SQLITE_API int sqlite3changegroup_change_double(sqlite3_changegroup *,
                                                  int,
                                                  int,
                                                  double);
  ...
  ** be nul-terminated.
  */
  SQLITE_API int sqlite3changegroup_change_text(sqlite3_changegroup *,
                                                int,
                                                int,
                                                const char *pVal,
                                                int nVal);
  ...
  */
  SQLITE_API int sqlite3changegroup_change_blob(sqlite3_changegroup *,
                                                int,
                                                int,
                                                const void *pVal,
                                                int nVal);
...
#  define FTS5_TOKEN_COLOCATED 0x0001 /* Same position as prev. token */
  ...
  */
  ...
  struct fts5_api {
    ...
    /* Create a new tokenizer */
    int (*xCreateTokenizer_v2)(fts5_api *pApi,
                               const char *zName,
                               void *pUserData,
